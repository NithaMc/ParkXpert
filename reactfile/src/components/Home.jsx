...
{/* CARIMAGE  */}
    <div className='container-fluid'>
      ...
      <h1 className='text-white parkhead'>Park <span  className='text-orange-700'>X</span>pert</h1>
      <div className='navbar'> 
      <div className='linksignup'>
        <Link to='/signup ' className='signtxt'>SIGNUP</Link> <span className='caret-orange-700'>|</span> <Link to='/login'className='signtxt'>LOGIN</Link>
      </div>
      <a href="#" className='txt'>Home</a>
      <a href="/about" className='txt'>About</a>
      <a href="/services" className='txt'>Services</a>
      <a href="/contact" className='txt'>Contact</a>
...
<div className='booking'>
    ...
    <div class="px-4 md:px-8 py-12 bg-black rounded-lg shadow-2xl max-w-xl">
    Book Your Slot Now
   
    {/* <h1 class="text-lg mb-4">
        Hey Amit<span class="mx-2" id="demo"></span>😄,
        <br>
        <span class="text-4xl font-semibold"> Have you booked your</span>
        <span class="text-4xl font-semibold text-blue-700">Seat?</span>
    </h1> */}
    ...
    <div class="flex flex-col justify-center w-full text-center mt-8 gap-6 sm:flex-row text-lg font-semibold">
       <input type="text" placeholder='Your Name..' onClick={handle}
            className="py-4 w-full bg-black text-white sm:w-40 border border-orange-500 rounded-lg hover:shadow-2xl hover:text-orange-500 shadow-lg"
        />
 
        <br />
        <a href="https://tailwindflex.com"  onClick={handle}
            class="bg-orange-500 w-full sm:w-40 py-4 rounded-lg text-white hover:bg-orange-500 shadow-lg">
            Book Now
        </a>
    </div>
      ...
      {/* <div className='circle bg-slate-400'>
       <span className='spn'> <LuUserCircle2/></span>
      </div> */}
    </div>
