...
// import { adminSignup } from '../redux/admin/reducer/authReducer'
import { adminSignup_API } from './apiServices'
import { UseDispatch,useDispatch } from 'react-redux'
import { isAdminSignup } from '../redux/admin/reducer/authReducer'
  ...
  const dispatch = useDispatch()
    ...
    let handleSubmit =async(e)=>{
          e.preventDefault()
            ...
            try{
            let response =await axios.post('http://localhost:5001/api/admin/register',datas)
...
<div>
    ...
    <form onSubmit={handleSubmit} className='form-container'>
        ...
        <input type="text" name='name' onChange={handleChange} placeholder='Admin Name' className='inputs'/> <br />
    ...
    <button><a href="admin/login"></a> Login</button> <br />
